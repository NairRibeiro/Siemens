sap.ui.define([
	...
	return Opa5.extend("Northwind.Project_Northwind.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Northwind/Project_Northwind/localService/mockserver"], function (mockserver) {
