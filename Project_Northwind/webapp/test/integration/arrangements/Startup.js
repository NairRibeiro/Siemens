sap.ui.define([
	"sap/ui/test/Opa5",
	"Northwind/Project_Northwind/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("Northwind.Project_Northwind.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "Northwind.Project_Northwind",
					async: true
				},
				hash: oOptions.hash,
